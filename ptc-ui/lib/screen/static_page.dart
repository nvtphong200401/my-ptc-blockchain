  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [IconButton(onPressed: () {}, icon: const Icon(IconlyBroken.more_circle))],
          elevation: 0,
        ),
        body: SingleChildScrollView(
          ...
          child: Column(children: [
            ...
            Text(
              '\$2,920',
              style: TextStyle(color: Colors.grey[100], fontSize: 25, fontWeight: FontWeight.bold),
            ),
            const Row(
            ...
            Container(
                ...
                height: 300,
                decoration:
                    BoxDecoration(color: Colors.grey[900], borderRadius: const BorderRadius.all(Radius.circular(20))),
                child: LineChart(
                  LineChartData(
                    ...
                    lineBarsData: [
                      LineChartBarData(
                        ...
                        isCurved: true,
                        barWidth: 1,
                        shadow: const Shadow(color: Colors.black, blurRadius: 4, offset: Offset(0, 5)),
